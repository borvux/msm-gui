Rails.application.routes.draw do
  ...
  post("/insert_actors", { :controller => "actors", :action => "create"} )
  get("/delete_actors/:path_id", { :controller => "actors", :action => "destroy" })
  post("/update_actors/:path_id", { :controller => "actors", :action => "update" })
end
